import type { ErrorHash, MarkerData, State, ValidatedState } from '$lib/client/types';
import { parse } from '$lib/client/features/diagram/mermaid';
...
const urlParseFailedState = `flowchart TD
    ...
    click D href "https://github.com/omkarbhad/graphini/issues/new?assignees=&labels=bug&template=bug_report.md&title=Broken%20link" "Raise issue"`;
